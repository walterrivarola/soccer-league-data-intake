...
import random
import os
#from utils2 import get_data,data_processing
from utils import get_data,data_processing
from datetime import datetime


default_arguments = {   'owner': 'WalterRivarola',
                        'email': 'rivarola.walter@gmail.com',
                        'retries':1 ,
...
with DAG('FOOTBAL_LEAGUES',
         ...
         df = pd.read_csv('./src/df_ligas.csv')
         df_team = pd.read_csv('./src/team_table.csv')
